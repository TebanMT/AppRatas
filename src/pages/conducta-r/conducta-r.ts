...
@IonicPage()
@Component({
  selector: 'page-conducta-r',
  templateUrl: 'conducta-r.html',
})
export class ConductaRPage {
  ...
  iEntradaSalida= new Array(this.sesionData.length).fill(0); // array salidas/entradas por rata
  ...
  entrada(rat){
    ...
    rat.disable = false;
    const index = this.sesionData.indexOf(rat);//buscar el index a la que pertenece el objeto recivido en el array sesionData
    this.eventos[index].events.push('en');// agregar eyeculacion('e') al array eventos 
    this.eventos[index].time.push(this.horas+':'+this.minutos+':'+this.segundos);//agregar el tiempo en el que ocurrio el evento eyaculacion al array evento
  ...
  salida(rat){
    ...
    rat.disable = true;
    const index = this.sesionData.indexOf(rat);//buscar el index a la que pertenece el objeto recivido en el array sesionData
    this.eventos[index].events.push('s');// agregar eyeculacion('e') al array eventos 
    this.eventos[index].time.push(this.horas+':'+this.minutos+':'+this.segundos);//agregar el tiempo en el que ocurrio el evento eyaculacion al array evento
